...
#define PWM_CH2  (3)
/**********************************************************/
#define   PWM_PRESCALER_NO        (0x00)
#define   PWM_PRESCALER_8         (0x01)
#define   PWM_PRESCALER_32        (0x02)
...
/***********************************************************/
#define   PWM_PRESCALER_NO_CONFIG       (0x01)
#define   PWM_PRESCALER_8_CONFIG        (0x02)
#define   PWM_PRESCALER_64_CONFIG       (0x03)
#define   PWM_PRESCALER_256_CONFIG      (0x04)
#define   PWM_PRESCALER_1024_CONFIG     (0x05)
